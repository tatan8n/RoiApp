    ...
    <div className="glass-panel p-8 relative overflow-hidden animate-fade-in">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-black text-amaq-700 mb-3 flex items-center gap-3">
          ...
          <span>Factores de Mejora (Benchmarks)</span>
        </h2>
        <p className="text-slate-600 font-semibold">
          Porcentajes de mejora esperados según benchmarks de industria. Puede ajustarlos según su contexto operativo.
        </p>
      </div>
      ...
      <div className="p-5 bg-amaq-50 border border-amaq-200 rounded-xl shadow-glow">
        <p className="text-sm text-slate-800 leading-relaxed font-semibold">
          <strong className="text-amaq-700">Nota:</strong> Los valores sugeridos están basados en estudios de DOE, McKinsey, Aberdeen Group y casos de éxito en plantas industriales de Latinoamérica. 
          Puede ajustarlos para simular escenarios más conservadores o agresivos.
        </p>
      </div>
    </div>
  )
