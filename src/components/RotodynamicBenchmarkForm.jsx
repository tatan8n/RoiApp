...
export default function RotodynamicBenchmarkForm({ benchmarks, onChange }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h2 className="text-xl font-bold text-navy-900 mb-1">Factores de Mejora Esperados</h2>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
        <p className="text-sm text-blue-700">
          <strong>Nota:</strong> Los valores sugeridos están basados en estudios de EPRI, McKinsey y casos de éxito en plantas de generación eléctrica de Latinoamérica.
          Puedes ajustarlos según la realidad de tucentral.
        </p>
      </div>
    </div>
  )
